...
namespace LaPiazzolla.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public AlumnosController(LaPiazzollaContext context)
        {
            _context = context;
        }
        ...
        {
            var laPiazzollaContext = _context.Alumnos.Include(a => a.Direccion).Include(a => a.Sexo);
            return View(await laPiazzollaContext.ToListAsync());
        }
